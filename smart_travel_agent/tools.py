...
Gemini free quota is currently exhausted, so fallback itinerary is active. The app is working safely without crashing.
"""

        if "404" in error_text or "NOT_FOUND" in error_text or "model" in error_text.lower():
            return """
**Day 1:** Arrival and local exploration.

**Day 2:** Main attractions and activities.

**Day 3:** Weather-friendly sightseeing.

**Day 4:** Shopping and return.
...
Gemini model is not available for this API key right now. Fallback itinerary is active. Try another model from test_gemini.py output.
"""
...
Gemini response is unavailable right now, so fallback itinerary is active.
"""